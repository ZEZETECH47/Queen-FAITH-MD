...
zokou({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {  
    ...
    repondre("THANK YOU FOR CHOOSING queen_faith-md, HERE ARE OUR SUPPORTIVE LINKS\n\n ☉ CHANNEL LINK IS HERE ☉\n\n❒⁠⁠⁠⁠[https://whatsapp.com/channel/0029VatokI45EjxufALmY32X] \n\n ☉ GITHUB LINK IS HERE ☉\n\n❒⁠⁠⁠⁠[https://github.com/Qartde/RAHMANI-XMD-BOT] \n\n\n𝑴𝒂𝒅𝒆 𝒃𝒚 𝑹𝒂𝒉𝒎𝒂𝒏𝒊 𝑴𝒅");  
    await zk.sendMessage(auteurMessage, { text: `THANK YOU FOR CHOOSING FAITH-MD, MAKE SURE YOU FOLLOW THESE LINKS.` }, { quoted: ms });  
});
